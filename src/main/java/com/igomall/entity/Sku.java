...
import com.igomall.plugin.GiftPromotionPlugin.GiftAttribute;
...
public class Sku extends BaseEntity<Long> {
	 ...
	 * 虚拟商品验证组
	 */
	public interface Virtual extends Default {
	 ...
	 */
	@Transient
	public BigDecimal getPlatformCommission(com.igomall.entity.Store.Type type) {
